        ...
        public static async Task InitializeAsync(IServiceProvider serviceProvider, ILogger logger)
        {
            ...
            try
            {
                ...
                var standardPermissions = new (string Key, string Name, string Desc)[]
                {
                    ...
                    ("designations.view", "View Designations", "View workspace designations and job titles."),
                    ("designations.create", "Create Designations", "Create and define new workspace designations."),
                    ("designations.edit", "Edit Designations", "Modify designation titles, descriptions, and department links."),
                    ("designations.delete", "Delete Designations", "Deactivate or delete designations."),
                    ("designations.manage", "Manage Designations", "Full administrative control over designations."),
                ...
                var defaultMenus = new List<MenuModel>
                {
                    ...
                    new() { MenuKey = "designations.view", Label = "Designations", Icon = "💼", Route = "/designations", GroupName = "Core Access", Description = "Workspace designations and title mapping", OrderIndex = 5, PermissionKey = "designations.view", DeletedFlag = 1 },
                    new() { MenuKey = "permissions.manage", Label = "Permission Matrix", Icon = "⚿", Route = "/permissions", GroupName = "Core Access", Description = "Role permission assignments", OrderIndex = 6, PermissionKey = "permissions.manage", DeletedFlag = 1 },
                    new() { MenuKey = "user_permissions.view", Label = "User Permissions", Icon = "🛡️", Route = "/user-permissions", GroupName = "Core Access", Description = "User direct permission access control & assignment", OrderIndex = 7, PermissionKey = "permissions.manage", DeletedFlag = 1 },
