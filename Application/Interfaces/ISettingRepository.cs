...
namespace MyBackend.Application.Interfaces
{
    ...
    {
        Task<(List<SystemSettingModel> Settings, List<SettingCategoryModel> Categories, Dictionary<string, int> SettingCounts, int TotalSettings, string? TwoFactorValue, int AlertChannels, string? SessionTimeout)> GetSettingsOverviewDataAsync(string? category, string? search);

        Task<(List<SettingCategoryModel> Categories, Dictionary<string, int> SettingCounts)> GetCategoriesWithCountsAsync();
        ...
        Task<SettingCategoryModel?> GetCategoryByIdAsync(int id);
        ...
        Task<SystemSettingModel?> GetSettingByIdAsync(int id);
